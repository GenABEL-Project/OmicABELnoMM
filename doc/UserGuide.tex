...
% Lowercase letters with a bracket as footnote numerals.
\renewcommand*{\thefootnote}{\alph{footnote})}
% Define the footnote mark in the text.
\deffootnotemark{\textsuperscript{\hspace{1pt}\thefootnotemark}}
% Add a bit of space after the footnote mark when we write the
...
\include{preparing_input}
\include{running_analysis}
\include{understanding_oanomm}
\include{faq}
